package com.example.hoada921.readrss.activity;
...
import com.example.hoada921.readrss.activity.fragment.FragmentListPost;
import com.example.hoada921.readrss.activity.fragment.FragmentMain;
import com.example.hoada921.readrss.controller.Database;
import com.example.hoada921.readrss.controller.ReadRssAsyncTask;
import com.example.hoada921.readrss.models.Data;
import com.example.hoada921.readrss.models.Informations;
import com.example.hoada921.readrss.models.LinkUrl;
...
//            Toast.makeText(this, " Connected ", Toast.LENGTH_LONG).show();
    ...
    private void updatePost(ArrayList<Data> data) {
        sqLiteDatabase = connectDataBase();
        if (sqLiteDatabase != null) {
    ...
    private void getArrListCatrgory(String category) {
        ...
        for (Data item : items) {
            for (String cate : item.getarrayListcategory())
                if (cate.equalsIgnoreCase(category.trim())) {
